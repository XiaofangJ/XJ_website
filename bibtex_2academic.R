# https://www.r-bloggers.com/automatically-importing-publications-from-bibtex-to-a-hugo-academic-blog/
...
bibtex_2academic <- function(bibfile,
  ...
  create_md <- function(x) {
    ...
    if (!file.exists(file.path(outfold, filename)) | overwrite) {
      ...
      #if ( ("doi" %in% colnames(x)) & (!is.na(x[["doi"]]))) publication <- paste0(publication, ", ", paste0("https://doi.org/", x[["doi"]]))
...
my_bibfile <- "./static/files/citations/publications.bib"
